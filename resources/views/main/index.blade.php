...
<html lang="en-us">
	...
	<body class="">
									...
									<div class="widget-body widget-hide-overflow no-padding">
										...
										<div id="chat-container">
											...
											<div class="chat-list-body custom-scroll">
												<ul id="chat-users">
													<li>
														<a href="javascript:void(0);"><img src="{{asset('resources/assets/main/img/avatars/5.png')}}">
													</li>
													<li>
														<a href="javascript:void(0);"><img src="{{asset('resources/assets/main/img/avatars/male.png')}}">
													</li>
													<li>
														<a href="javascript:void(0);"><img src="{{asset('resources/assets/main/img/avatars/male.png')}}">
													</li>
													...
													<li>
														<a href="javascript:void(0);"><img src="{{asset('resources/assets/main/img/avatars/sunny.png')}}">
													</li>
													<li>
														<a href="javascript:void(0);"><img src="{{asset('resources/assets/main/img/avatars/male.png')}}">
													</li>
										...
										<div id="chat-body" class="chat-body custom-scroll">
											<ul>
												<li class="message">
													<img src="{{asset('resources/assets/main/img/avatars/5.png')}}" class="online">
												...
												<li class="message">
													<img src="{{asset('resources/assets/main/img/avatars/sunny.png')}}" class="online">
													<div class="message-text">
														<time>
															2014-01-13
		...
		<script data-pace-options='{ "restartOnRequestAfter": true }' src="{{asset('resources/assets/main/js/plugin/pace/pace.min.js')}}"></script>
		...
		<script src="{{asset('resources/assets/main/js/app.config.js')}}"></script>

		<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
		<script src="{{asset('resources/assets/main/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js')}}"></script>

		<!-- BOOTSTRAP JS -->
		<script src="{{asset('resources/assets/main/js/bootstrap/bootstrap.min.js')}}"></script>

		<!-- CUSTOM NOTIFICATION -->
		<script src="{{asset('resources/assets/main/js/notification/SmartNotification.min.js')}}"></script>

		<!-- JARVIS WIDGETS -->
		<script src="{{asset('resources/assets/main/js/smartwidgets/jarvis.widget.min.js')}}"></script>

		<!-- EASY PIE CHARTS -->
		<script src="{{asset('resources/assets/main/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js')}}"></script>

		<!-- SPARKLINES -->
		<script src="{{asset('resources/assets/main/js/plugin/sparkline/jquery.sparkline.min.js')}}"></script>

		<!-- JQUERY VALIDATE -->
		<script src="{{asset('resources/assets/main/js/plugin/jquery-validate/jquery.validate.min.js')}}"></script>

		<!-- JQUERY MASKED INPUT -->
		<script src="{{asset('resources/assets/main/js/plugin/masked-input/jquery.maskedinput.min.js')}}"></script>

		<!-- JQUERY SELECT2 INPUT -->
		<script src="{{asset('resources/assets/main/js/plugin/select2/select2.min.js')}}"></script>

		<!-- JQUERY UI + Bootstrap Slider -->
		<script src="{{asset('resources/assets/main/js/plugin/bootstrap-slider/bootstrap-slider.min.js')}}"></script>

		<!-- browser msie issue fix -->
		<script src="{{asset('resources/assets/main/js/plugin/msie-fix/jquery.mb.browser.min.js')}}"></script>

		<!-- FastClick: For mobile devices -->
		<script src="{{asset('resources/assets/main/js/plugin/fastclick/fastclick.min.js')}}"></script>
		...
		<!-- Demo purpose only -->
		<script src="{{asset('resources/assets/main/js/demo.min.js')}}"></script>

		<!-- MAIN APP JS FILE -->
		<script src="{{asset('resources/assets/main/js/app.min.js')}}"></script>

		<!-- ENHANCEMENT PLUGINS : NOT A REQUIREMENT -->
		<!-- Voice command : plugin -->
		<script src="{{asset('resources/assets/main/js/speech/voicecommand.min.js')}}"></script>

		<!-- SmartChat UI : plugin -->
		<script src="{{asset('resources/assets/main/js/smart-chat-ui/smart.chat.ui.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/smart-chat-ui/smart.chat.manager.min.js')}}"></script>
		
		<!-- PAGE RELATED PLUGIN(S) -->
		
		<!-- Flot Chart Plugin: Flot Engine, Flot Resizer, Flot Tooltip -->
		<script src="{{asset('resources/assets/main/js/plugin/flot/jquery.flot.cust.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/plugin/flot/jquery.flot.resize.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/plugin/flot/jquery.flot.time.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/plugin/flot/jquery.flot.tooltip.min.js')}}"></script>
		
		<!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
		<script src="{{asset('resources/assets/main/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
		
		<!-- Full Calendar -->
		<script src="{{asset('resources/assets/main/js/plugin/moment/moment.min.js')}}"></script>
		<script src="{{asset('resources/assets/main/js/plugin/fullcalendar/fullcalendar.min.js')}}"></script>
